...
To upload packages through the command line:<br><br>
<pre>
...
<br>
To upload packages via web:<br><br>
...
<form novalidate class="simple-form col-md-12">
	...
	<div class="form-group col-md-12">
		...
		<div class="col-md-8">
			<input type="text"  name="Id" ng-model="downloadItem.Id"/>
		</div>
	</div>
	<div class="form-group col-md-12">
		<div class="col-md-2">
		...
		<div class="col-md-8">
			<input type="text"  name="Version"  ng-model="downloadItem.Version"/>
		</div>
	</div>
